...
class ContactTVCell: BaseTableViewCell {
    ...
    private func updateUI() {
        ...
        contentView.borderWidth = model.isSelected ?? false ? 2 : 0
        contentView.borderColor = UIColor(red: 0.2, green: 0.2, blue: 1, alpha: 1)
